      ...
      <Container>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {features.map((feature, index) => (
            <div
              key={index}
              className="flex items-start gap-4 p-6 rounded-[8px] bg-[#0d0d0d] border border-border hover:border-primary transition-colors duration-200"
            >
        ...
        {/* Placeholder for future screenshot/demo UI */}
        <div className="mt-10 rounded-[8px] border border-border bg-[#0d0d0d] p-10 text-center">
